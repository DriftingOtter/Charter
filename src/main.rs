...
pub fn init_ssh_session(local_host: &str, local_port: u16, remote_host: &str, username: &str, password: &str) -> Result<Session, String> {
    println!(
...
pub fn create_ephemeral_remote_openport(local_host: &str, local_port: u16, remote_host: &str, remote_port: u16, username: &str, password: &str, lifetime: u64) -> Result<Vec<Vec<u8>>, String> {
